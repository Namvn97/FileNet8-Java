...
public class Demo extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "demoDojo.ConfigurationPane";
	}
	...
	/**
	    ...
	    public com.ibm.ecm.extension.PluginFeature[] getFeatures() {
	       return new com.ibm.ecm.extension.PluginFeature[] {new vsii.CreateFoder()};
	    }
	...
	public com.ibm.ecm.extension.PluginService[] getServices() {
		return new com.ibm.ecm.extension.PluginService[]{new vsii.CreateFolderService()};
	}
